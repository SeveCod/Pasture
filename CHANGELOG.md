...
- Test count: 501 → 595 (MCP: `MCPResourcesTests`, `MCPPromptsTests`; Context Compiler: `SyncMarkerTests`, `PackCompilerTests`, `TargetValidatorTests`, `PackStoreTests`, `PackWriterTests`, `PackSyncEngineTests`; Living context: `FrontmatterParserTests`, `FreshnessTests`, `FrontmatterWriterTests`, `MCPStalenessTests`; extended `MCPProtocolTests`, `MCPEndToEndTests`, `MCPToolsTests`).
