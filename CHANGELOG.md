...
- Test count: 501 → 567 (MCP: `MCPResourcesTests`, `MCPPromptsTests`; Context Compiler: `SyncMarkerTests`, `PackCompilerTests`, `TargetValidatorTests`, `PackStoreTests`, `PackWriterTests`, `PackSyncEngineTests`; extended `MCPProtocolTests`, `MCPEndToEndTests`).
